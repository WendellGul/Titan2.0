 ...
 */
public class MyBaseVertexCentricQuery extends BaseQuery implements ProfileObservable {
     ...
     */
    protected final List<BackendQueryHolder<EdgeSliceQuery>> queries;
    /**
    ...
    public MyBaseVertexCentricQuery(Condition<TitanRelation> condition, Direction direction,
                                  List<BackendQueryHolder<EdgeSliceQuery>> queries, OrderList orders,
                                  int limit) {
        super(limit);
    ...
    protected MyBaseVertexCentricQuery(MyBaseVertexCentricQuery query) {
     ...
     */
    protected MyBaseVertexCentricQuery() {
        this(new FixedCondition<TitanRelation>(false), Direction.BOTH, new ArrayList<BackendQueryHolder<EdgeSliceQuery>>(0),OrderList.NO_ORDER,0);
    }

    public static MyBaseVertexCentricQuery emptyQuery() {
        return new MyBaseVertexCentricQuery();
    }
    ...
    protected List<BackendQueryHolder<EdgeSliceQuery>> getQueries() {
        return queries;
    }
    ...
    public BackendQueryHolder<EdgeSliceQuery> getSubQuery(int position) {
