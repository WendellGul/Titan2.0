 ...
 * then we use the {@link MySimpleVertexQueryProcessor} to execute the query instead of the generic {@link QueryProcessor}
 ...
 */
public class MyVertexCentricQueryBuilder extends MyBasicVertexCentricQueryBuilder<MyVertexCentricQueryBuilder> implements TitanVertexQuery<MyVertexCentricQueryBuilder> {
    ...
    public MyVertexCentricQueryBuilder(InternalVertex v) {
        super(v.tx());
    ...
    @Override
    protected MyVertexCentricQueryBuilder getThis() {
        return this;
    }
