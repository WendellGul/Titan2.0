 ...
 */
public class MyCacheVertexProperty extends AbstractVertexProperty {

    private final MyEntry data;

    public MyCacheVertexProperty(long id, PropertyKey key, InternalVertex start, Object value, MyEntry data) {
