 ...
 */
public class MyVertexCentricQuery extends MyBaseVertexCentricQuery implements ElementQuery<TitanRelation, EdgeSliceQuery> {

    private final InternalVertex vertex;

    public MyVertexCentricQuery(InternalVertex vertex, Condition<TitanRelation> condition,
                              Direction direction,
    ...
    public MyVertexCentricQuery(InternalVertex vertex, MyBaseVertexCentricQuery base) {
        super(base);
        Preconditions.checkNotNull(vertex);
        this.vertex = vertex;
    }
     ...
     * @param vertex
     */
    protected MyVertexCentricQuery(InternalVertex vertex) {
        super();
        Preconditions.checkNotNull(vertex);
        this.vertex = vertex;
    }

    public static MyVertexCentricQuery emptyQuery(InternalVertex vertex) {
        return new MyVertexCentricQuery(vertex);
    }
